...
if __name__ == "__main__":
    ...
    create_pdf(call_info=call_info, internet_info=internet_info, bank_name="Лучший Банк", inn='11122233', kpp='0000001',
               bik='31337',
               recipient="Иванов Иван", account_number1="111111", account_number2="222222",
               doc_number="1", date=datetime.now().strftime("%d.%m.%Y"),
               provider="Провайдер", customer="Иван ({}, {})".format(IP, MY_PHONE), reason="День оплаты")
